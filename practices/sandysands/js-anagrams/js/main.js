...
var anagrams = ["enlists", "google", "inlets", "banana", "einlist"];
...
console.log(anagram("listens"))


var anagrammmer = {
  anagramsList: ["enlists", "google", "inlets", "banana", "listens"],
...
console.log(anagrammmer.findAnagram("listen"))
